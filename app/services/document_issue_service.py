...
ISSUE_CATALOG: dict[str, dict[str, str]] = {
    ...
    "ai_provider_not_configured": {
        "severity": "critical",
        "title": "Proveedor IA no configurado",
        "message": "No hay un proveedor IA configurado para ejecutar el prechequeo documental.",
        "suggested_action": "wait_and_retry",
    },
    "ai_provider_error": {
        "severity": "critical",
        "title": "Error del proveedor IA",
    ...
    "ai_provider_json_schema_error": {
        "severity": "critical",
        "title": "Formato JSON IA rechazado",
        "message": "El proveedor IA rechazo el formato JSON solicitado.",
        "suggested_action": "wait_and_retry",
    },
    "ai_provider_token_limit": {
        "severity": "critical",
        "title": "Limite de tokens IA",
        "message": "El proveedor IA rechazo la solicitud por limite de tokens.",
        "suggested_action": "wait_and_retry",
    },
    "storage_read_error": {
        "severity": "critical",
        "title": "Error leyendo almacenamiento",
        "message": "No fue posible leer el archivo almacenado para el prechequeo documental.",
        "suggested_action": "wait_and_retry",
    },
    "ocr_failed": {
        "severity": "critical",
        "title": "Error OCR",
        "message": "No fue posible ejecutar la lectura OCR preliminar.",
        "suggested_action": "wait_and_retry",
    },
    "ocr_provider_not_configured": {
        "severity": "critical",
        "title": "OCR no configurado",
        "message": "El PDF no contiene texto embebido y no hay un motor OCR configurado.",
        "suggested_action": "upload_better_scan",
    },
